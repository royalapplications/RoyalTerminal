...
// RoyalTerminal.Rendering.Skia - DXC CLI shader compiler backend.
...
public sealed class TerminalShaderDxcCliCompiler : ITerminalShaderCompiler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        TerminalShaderReflection reflection = new(
            [
                new TerminalShaderEntryPointReflection(
                    pass.EntryPoint,
                    pass.Stage,
                    pass.Stage == TerminalShaderStage.Compute ? pass.Dispatch : null),
            ]);
        TerminalShaderCompiledPass compiledPass = new(
            ...
            code,
            reflection);
        return new TerminalShaderCompilationResult([compiledPass]);
    }
